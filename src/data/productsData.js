  ...
  section4: {
    ...
    products: [
      ...
      },
      {
        ...
        id: 11,
        img: "/car11-1-removebg-preview.png",
        name: "RC Racing Car – Speed & Fun",
        description:"Race into action with this sleek and stylish RC Racing Car, perfect for kids and beginners! Powered by a rechargeable battery and comes with a charger, it offers endless fun without breaking the bank.High-Speed Racing Performance.Rechargeable Battery with Charger Included.Easy-to-Use Remote Control.Budget-Friendly Price.Perfect for Indoor & Outdoor Play.Great value, great performance – the ultimate budget RC car for non-stop racing excitement!",
        type: "Classic",
        price: ["649","1199"],
      },{
        id: 12,
        img: "/car12-1-removebg-preview.png",
        name: "RC  High Speed Drift Car - 1:16",
        description:"Bring home the thrill of a supercar with this premium 1:32 scale Die-Cast Lamborghini! Crafted with attention to detail, it features openable doors, realistic engine sound, working lights, and a pull-back action for added fun.1:32 Scale Die-Cast Model.Openable Doors for realistic play.Sound & Light Effects.Pull-Back Function – just pull and release.High-Quality Metal Body.A perfect collectible and play car for kids and supercar lovers",
        type: "Classic",
        price: ["2200","2999"],
      },{
        id: 13,
        img: "/car13-1-removebg-preview.png",
