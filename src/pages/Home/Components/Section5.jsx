  ...
  return (
    <section className="bg-gray-50 py-20">
      <div className="container mx-auto px-6">
        <div className="relative max-w-3xl mx-auto bg-white shadow-lg rounded-2xl p-10 text-center transition-all duration-500">
          {/* Left Arrow */}
          <button
            onClick={prevTestimonial}
            className="absolute left-[-200px] top-1/2 transform -translate-y-1/2 p-3 border rounded-full bg-white hover:bg-gray-100 shadow-md"
          >
            <ArrowLeft size={22} />
          </button>
          ...
          <button
            ...
            className="absolute right-[-200px] top-1/2 transform -translate-y-1/2 p-3 border rounded-full bg-white hover:bg-gray-100 shadow-md"
          >
            <ArrowRight size={22} />
          </button>
        </div>
